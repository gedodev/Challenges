...
// function findSpy(arr){
//     arr.forEach((s,i)=>{
//         //delete all the dupicates and have counter of how many of them are
//         while(arr.includes(s)){
//             // console.log(`array: ${suspects}`,`suspect: ${s}`,`index: ${i}`,`counter= ${counter}`)
//             counter++
//             arr.splice(arr.indexOf(s),1)
//             // console.log(`array: ${suspects}`,`suspect: ${s}`,`index: ${i}`,`counter= ${counter}`)
//         }
